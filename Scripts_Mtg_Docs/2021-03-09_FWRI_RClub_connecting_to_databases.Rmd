...
In order to access the data and take advantage of all R has to offer (wrangling, visualizing, analyzing), you could query from your database and save as .csv files and then load into R...or you can connect R directly to your database, which can aid in reproducibility.
